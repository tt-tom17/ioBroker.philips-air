...
class AirPurifier extends EventEmitter {
     ...
     */
    control(settings) {
        const payload = buildControlPayload(settings, this.generation === 'new-gen');
     ...
     * (e.g. a firmware/filter response carrying neither marker) leaves the previous decision intact.
     * The raw status is left unchanged - decoding happens generation-agnostically in main.js.
     *
